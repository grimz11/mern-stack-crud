...
class Edit extends PureComponent {
  ...
  componentDidMount = async () => {
    ...
    if(this.props.fetchPerson !== undefined) {
      ...
      this.setState({id: _id,firstname: firstName, lastname: lastName, birthday: birthday, address: address, hobbies: hobbies})
    }
  }
  ...
  render() {
    const {id, address, birthday, firstname, lastname, hobbies, doneUpdate} = this.state;
